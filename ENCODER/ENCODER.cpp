...
// ENCODER.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CENCODERApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CENCODERApp
...
// Единственный объект CENCODERApp

CENCODERApp theApp;


// Инициализация CENCODERApp

BOOL CENCODERApp::InitInstance()
{
